...
//        DID NOT IMPLEMENT: picCaptionName (field name of caption)
    ...
    if (params.resortName) {
        var resortName = params.resortName;
    }
    ...
    var myCaption = document.createElement("h3");
    ...
    slideShowEle.setNewCaption = function (newCaption) {
        myCaption.innerHTML = newCaption;
        if (userEmail){
            objList[picNum].userEmail = newCaption;
        }
        if (resortName){
            objList[picNum].resortName = newCaption;
        }
    };
    ...
    function updatePic() {
        ...
        if (userEmail) {
            myCaption.innerHTML = obj[userEmail];
        }

        if (resortName) {
            myCaption.innerHTML = obj[resortName];
        }
    }
