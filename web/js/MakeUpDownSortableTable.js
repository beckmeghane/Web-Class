function MakeUpDownSortableTable(list, id, sortOrderPropName, icon) {
    ...
    function addSortedDataRows(sortField, isReverse, filterValue) {
    ...
    for (var prop in obj) {
        ...
        colHead.onclick = function () {
            ...
            addSortedDataRows(this.sortProp, this.isReverse, searchInput.value);
    ...
    addSortedDataRows(sortOrderPropName, false, searchInput.value);
