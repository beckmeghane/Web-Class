...
public class DbConn {
    ...
    public DbConn() {
        ...
        String dbAndPass = "SP20_3308_tug43477?user=tug43477&password=jiathaic";
        ...
        try {
            ...
            try {
                ...
                recordError("Database unavailable. Make sure you are tunneling in from outside of the network. Problem getting connection:" + e.getMessage());
            }
